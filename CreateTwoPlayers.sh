...
java -classpath out/production/TigerZone com.tigerzone.fall2016server.client.ParameterizedClientMain PLAYER4  PASSWORD4 Player1Moves.txt MalformedMoves.txt localhost 444