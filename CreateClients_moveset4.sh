...
java -classpath out/production/TigerZone com.tigerzone.fall2016server.client.ParameterizedClientMain TEAMA IAMB moveset4_P1.txt moveset4_P2.txt localhost 4444