...
java -classpath out/production/TigerZone com.tigerzone.fall2016server.client.ParameterizedClientMain TEAMD  IAMD Player1Moves.txt MalformedMoves.txt localhost 4444